...
const eventTypeToPrompt: Record<string, string> = {
  "Coffee chat": "a coffee chat",
  "EIS": "an employer information session",
  "Other": "recruiting events"
}

const formalityLevels: Record<number, string> = {
  1: "casual",
  2: "engaging", 
...
const systemPromptTemplate = 
  ...
  "All thank-you emails should be short - only {lines} lines. Only If relevant, this GPT should ask a question like \"What do you think I can do at Wharton to be better at X\". It should mention the person's name in the beginning of the email (as in \"My name is [Your Name]\"). This GPT is short and concise, and sounds natural for a native English speaker."
